<template>
	...
	<div style="color:#fff;font-weight:bold;font-size:150%;top:5px;left:600px;position:absolute;visibility: visible;z-index: 100;padding: 0px 40px;background-color: red;">TEST SERVER</div>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script> -->
	...
	<div><a href="<!--#include virtual="/ssi/internet_server.htm"-->index.htm"><img style="margin: 3px;" src="/img/new-acgov-logo-standard-header.png" alt="Alameda County, CA, acgov.org" width="180" height="44" /></a></div>
    ...
    <div id="mainsite" aria-labelledby="mainsite" style="clear: both;padding-top: 0px;"></div>
</header>	
</template>
